...
function run_mms_verification_1_direct()
    ...
    # Plot convergence
    p1 = plot(dt_values, [errors_lie errors_strang errors_adi_direct errors_fd], 
              xlabel="Time step", ylabel="L2 Error", 
              label=["Lie" "Strang" "ADI Direct" "FD \$dt \\cdot 10^{-4}\$"], 
              xscale=:log10, yscale=:log10,
              markershape=[:circle :x :hexagon :rect], linestyles = [:solid :solid :solid :dash], title="MMS Convergence - Potential 1", legend=:outertopright)
    
    return p1, errors_lie, errors_strang, errors_adi_direct, errors_fd
end
...
function run_mms_verification_2_direct()
    ...
    p1 = plot(dt_values, [errors_lie errors_strang errors_adi_direct errors_fd], 
              ...
              label=["Lie" "Strang" "ADI Direct" "FD \$dt \\cdot 10^{-4}\$"], 
              xscale=:log10, yscale=:log10,
              markershape=[:circle :x :hexagon :rect], linestyles = [:solid :solid :solid :dash], title="MMS Convergence - Potential 2", legend=:outertopright)
