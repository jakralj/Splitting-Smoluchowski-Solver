...
data = DataFrame(
    ...
    L2_error = [
        2.2504374508126314e-8,
        4.523688799267581e-8,
        1.1344154976862568e-7,
        2.2714045772631198e-7,
        3.193787275141704e-5,
        2.2806103151711206e-6,
        0.0003194807501455828,
        2.2682059522720042e-10,
        2.2756541132851327e-10,
        2.8059143198592765e-10,
        7.252413273670503e-10,
        3.188200660101674e-5,
        6.981349173832454e-8,
        0.0003189784435378143,
        0.017360979211303237,
        0.01736086335448786,
        0.017360515889953687,
        0.01735993714029405,
        0.017359679956352528,
        0.01734959616475071,
...
p1 = plot(
    title = "Convergence Analysis: L² Error vs Time Step",
    xlabel = L"\Delta t",
    ylabel = L"L^2 Error",
    xscale = :log10,
    yscale = :log10,
...
p3 = plot(
    title = "Total Variation (Stability Indicator)",
    xlabel = L"\Delta t",
...
p5 = plot(
    title = "Error vs Mass Conservation Trade-off",
...
p6 = plot(
    title = "Convergence Rate Analysis (Fine Time Steps)",
    xlabel = L"\Delta t",
    ylabel = L"L^2 Error",
    xscale = :log10,
    yscale = :log10,
